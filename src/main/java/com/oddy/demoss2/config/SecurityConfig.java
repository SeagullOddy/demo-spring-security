...
import com.oddy.demoss2.service.impl.AccountUserDetailsService;
...
public class SecurityConfig {
  ...
  // 提供一个认证管理器，用于处理密码校验？？
  // 为了在修改密码时，能够校验旧密码
//  private AuthenticationManager authenticationManager(UserDetailsManager userDetailsManager,
...
//    return manager;
    ...
    // 实现 UserDetailsService/UserDetailsManager 接口
